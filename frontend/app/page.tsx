      ...
      <Sidebar variant="inset">
          ...
          <SidebarMenu>
            <SidebarMenuItem>
              <SidebarMenuButton size="lg" asChild>
                <a href="#">
                  <div className="flex aspect-square size-12 items-center justify-center rounded-lg bg-white text-sidebar-primary-foreground">
                    <svg
        ...
        <SidebarContent>
          ...
          <SidebarGroup className="group-data-[collapsible=icon]:hidden">
            <SidebarGroupLabel>Makerworld</SidebarGroupLabel>
            <SidebarMenu>
